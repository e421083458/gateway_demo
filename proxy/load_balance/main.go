...
import (
	"bytes"
	"github.com/e421083458/gateway_demo/proxy/load_balance/common"
	"io/ioutil"
	"log"
	"net"
	"net/http"
...
func NewMultipleHostsReverseProxy(lb common.LoadBalance) *httputil.ReverseProxy {
	//请求协调者
...
func main() {
	rb := common.LoadBanlanceFactory(common.LbConsistentHash)
